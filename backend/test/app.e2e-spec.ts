 ...
 *
 * Requires a live PostgreSQL + Redis (e.g. `docker compose up -d` at the
 * repo root) — NOT run by CI yet (docs/TECHNICAL_ARCHITECTURE.md notes
 * service-container wiring starts Phase 1). Run locally with:
 *   npm run test:e2e
 */
